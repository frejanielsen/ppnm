...
printf("integral of cos(x)*cos(y) from 0 to pi , with 30000 points:\n");
printf("plainmc called. \nres=%f\nerr=%f\nactual result: 0\n\n",res,err);
...
printf("multidimensional integration on integral of cos(x)*cos(y) from 0 to 3.14159265 in both x and y, with 30k points:");
N=30000;
multimc(dim,f3,a3,b3,N,&res,&err);
